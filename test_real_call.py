#!/usr/bin/env python3
"""
Test real phone call with environment variables
"""
...
async def test_real_call():
    """Test real phone call to the specified number"""
    print("📞 Testing REAL Phone Call")
    print("=" * 40)
    
    # Check environment variables
    print(f"VAPI_API_KEY: {'Set' if os.getenv('VAPI_API_KEY') else 'Not set'}")
    print(f"VAPI_PHONE_NUMBER_ID: {'Set' if os.getenv('VAPI_PHONE_NUMBER_ID') else 'Not set'}")
    print()
