#!/usr/bin/env python3
"""
Test the real integration with phone calls to +19259892492
"""
...
async def test_real_integration():
    """Test the real integration with phone calls"""
    print("🧪 Testing Real Integration with Phone Calls")
    print("=" * 60)
    ...
    print(f"\n🚨 Step 1: Sending PERMISSION call")
    print("-" * 40)
    
    permission_result = voice_service.send_warning_call(phone_number, "Test User")
    ...
    print(f"\n✅ Step 3: Sending COMPLETION call")
    print("-" * 40)
    ...
    if permission_result['success'] and completion_result['success']:
        print(f"\n🎉 SUCCESS! Both calls were initiated successfully!")
        ...
        print(f"\n❌ Some calls failed. Check the error messages above.")
